...
**[:arrow_up:Вернуться к Оглавлению](#36-класс-стек-реализация-на-однонаправленном-списке-разработайте-функцию-для-сложения-двух-целых-чисел-большой-разрядности-представляя-каждое-число-в-объекте-стек)**
