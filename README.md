<h1 align="center">
<br>
  <a href="https://github.com/ForWhomTheBellTolls/SiAOD"><img src="https://imgur.com/2kPWwMA" alt="Криогенный мир дискретного анализа или как сделать умное лицо на экзамене по СиАОД" width=100"></a>
  <br>
    <br>
...
1. **[В чем заключаются достоинства и недостатки последовательного и связанного способов реализации динамических структур данных?](#1-call-stack)**
...
## В чем заключаются достоинства и недостатки последовательного и связанного способов реализации динамических структур данных?
