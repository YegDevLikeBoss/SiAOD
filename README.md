...
23. **[<span id="23">АТД сильно ветвящееся дерево. Способы реализация. Алгоритмы обхода в глубину</span>](#23-атд-сильно-ветвящееся-дерево-способы-реализация-алгоритмы-обхода-в-глубину)**
...
**[:arrow_up:Вернуться к Оглавлению](<a href="https://github.com/ForWhomTheBellTolls/SiAOD/blob/master/README.md#1-в-чем-заключаются-достоинства-и-недостатки-последовательного-и-связанного-способов-реализации-динамических-структур-данных>)**
...
**[:arrow_up:Вернуться к Оглавлению](#23)**
